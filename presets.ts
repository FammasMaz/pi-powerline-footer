...
export const PRESETS: Record<StatusLinePreset, PresetDef> = {
  ...
  full: {
    ...
    rightSegments: ["token_in", "token_out", "cache_read", "cost", "context_pct", "tps_live", "ttft_avg", "time_spent", "time", "extension_statuses"],
    separator: "powerline",
    colors: DEFAULT_COLORS,
    segmentOptions: {
      model: { showThinkingLevel: false },
  ...
  nerd: {
    ...
    rightSegments: ["token_in", "token_out", "cache_read", "cache_write", "cost", "context_pct", "context_total", "tps_live", "ttft_avg", "time_spent", "time", "extension_statuses"],
    separator: "powerline",
    colors: NERD_COLORS,
    segmentOptions: {
      model: { showThinkingLevel: false },
